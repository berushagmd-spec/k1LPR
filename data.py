...
KURBANIA_ZONES = {
    ...
    "north_close": {"region": "Сугдинская область", "depth": "close", "direction": "север", "places": ["Сокол", "Велена", "Доковы"]},
...
MISSILE_TYPES = {
    "ballistic": ["ОТРК «Ураган-Т»", "ОТРК «Рубеж-М»", "БРСД «Суховей-4»", "БЖРК «Магистраль»"],
    "missile": ["КР «Корсар»", "ракеты наземного базирования", "крылатые ракеты", "тактические ракеты"],
}
